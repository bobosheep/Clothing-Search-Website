...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = 'app';
        this.clc = Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["fromEvent"])(window, 'scroll')
            .subscribe(function (e) {
            var d1 = document.documentElement;
            var d2 = document.body;
            var ele1 = document.getElementById('go-top-icon');
            var ele2 = document.getElementById('go-top-icon');
...
/***/ "./src/app/search-result/advance-search.component.html":
/*!*************************************************************!*\
  !*** ./src/app/search-result/advance-search.component.html ***!
  \*************************************************************/
/*! no static exports found */
...
/***/ "./src/app/search-result/advance-search.component.ts":
/*!***********************************************************!*\
  !*** ./src/app/search-result/advance-search.component.ts ***!
  \***********************************************************/
...
var AdvanceSearchComponent = /** @class */ (function () {
    ...
    AdvanceSearchComponent.prototype.OnPriceSelected = function (event) {
        this.priceOption = event.target.value;
    };
    AdvanceSearchComponent.prototype.toggleWeb = function (name) {
        var idx = this.advanceChoose.site.indexOf(name);
        if (idx > -1) {
    ...
    AdvanceSearchComponent.prototype.toggleCategory = function (name) {
        var idx = this.advanceChoose.category.indexOf(name);
        if (idx > -1) {
    ...
    AdvanceSearchComponent.prototype.toggleColors = function (color) {
        var idx = this.advanceChoose.color.indexOf(color);
        if (idx > -1) {
    ...
    AdvanceSearchComponent.prototype.toggleSizes = function (size) {
        var idx = this.advanceChoose.sizes.indexOf(size);
        if (idx > -1) {
    ...
    AdvanceSearchComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./advance-search.component.html */ "./src/app/search-result/advance-search.component.html"),
            styles: ["label{\n      margin-left: 5px;\n      margin-right: 5px;\n    }"]
        }),
...
/* harmony import */ var _advance_search_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./advance-search.component */ "./src/app/search-result/advance-search.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SearchResultComponent = /** @class */ (function () {
    function SearchResultComponent(http) {
        ...
        this.clc = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(window, 'scroll')
            .subscribe(function (e) {
            var d1 = document.documentElement;
            var d2 = document.body;
            var ele1 = document.getElementById('go-top-icon');
        ...
        this.chooseSort = function (v) {
            if (v === 'default') {
                _this.sortIsActive.default = 'is-active';
                _this.sortIsActive.priceAsc = '';
                _this.sortIsActive.priceDesc = '';
                _this.sortChoose.default = true;
                _this.sortChoose.price.asc = false;
                _this.sortChoose.price.desc = false;
            }
            else if (v === 'price asc') {
                _this.sortIsActive.default = '';
                _this.sortIsActive.priceAsc = 'is-active';
                _this.sortIsActive.priceDesc = '';
                _this.sortChoose.default = false;
                _this.sortChoose.price.asc = true;
                _this.sortChoose.price.desc = false;
            }
            else if (v === 'price desc') {
                _this.sortIsActive.default = '';
                _this.sortIsActive.priceAsc = '';
                _this.sortIsActive.priceDesc = 'is-active';
                _this.sortChoose.default = false;
                _this.sortChoose.price.asc = false;
                _this.sortChoose.price.desc = true;
            }
        };
        this.getSearch = function () {
            ...
            if (_this.query.length >= 0) {
                ...
                var gender = { term: { gender: _this.genderOption } };
                if (_this.advance_search === 'Yes') {
                    //如果有進階搜尋的話
                    for (var i in _this.advanceSearch.advanceChoose) {
                        //建立must 裡的bool should
                        var bool_should = new Object();
                        bool_should["bool"] = { should: [] };
                        for (var j in _this.advanceSearch.advanceChoose[i]) {
                            var idx = _this.advanceSearch.advanceChoose[i];
                            if (i === 'sizes') {
                ...
                if (_this.query.length > 0)
                    matcharr.push({ match: { name: _this.query } });
                //this.queryBody.query.query_string.query = 'name:' + this.query
                if (!(_this.genderOption === 'ALL'))
                ...
                if (!_this.sortChoose.default && _this.sortChoose.price.asc)
                    sortOption.push({ price: { order: 'asc' } });
                else if (!_this.sortChoose.default && _this.sortChoose.price.desc)
                ...
                queryBody = {
                    ...
                    from: (_this.nowpage - 1) * 20,
                    size: _this.querySize,
                    sort: sortOption
                };
                ...
                _this.http.post("/search", queryBody) //this.http.post(`http://localhost:5100/search`, this.queryClothes, this.httpOptions)
                    ...
                    if (_this.response.length > 0) {
                        ...
                        _this.have_result = false;
                    }
                }); //end http.post
                if (_this.nowpage > 3) {
                    var mid_1 = _this.pages[2].page;
                    _this.pages.forEach(function (element) {
                        element.page += _this.nowpage - mid_1;
                    });
                }
                else {
                    _this.pages.forEach(function (element, i) {
                        element.page = i + 1;
                    });
                }
                _this.pages.forEach(function (element) {
                    if (element.page == _this.nowpage)
    ...
    SearchResultComponent.prototype.OnSelectGender = function (event) {
        this.genderOption = event.target.value;
    };
    SearchResultComponent.prototype.showAdvance = function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_advance_search_component__WEBPACK_IMPORTED_MODULE_4__["AdvanceSearchComponent"]),
        __metadata("design:type", Object)
    ], SearchResultComponent.prototype, "advanceSearch", void 0);
    SearchResultComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            animations: [
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["trigger"])('HaveAdvance', [
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["state"])('No', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["style"])({
                        opacity: 0,
                        display: 'none'
                    })),
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["state"])('Yes', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["style"])({
                        opacity: 1,
                        display: 'block'
                    })),
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["transition"])('No=> Yes', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["animate"])('1s ease')),
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["transition"])('Yes => No', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_3__["animate"])('1s ease'))
                ])
            ]
        }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])
...
module.exports = __webpack_require__(/*! D:\Sheep\G-YOC\src\main.ts */"./src/main.ts");
