...
var HomePageComponent = /** @class */ (function () {
    function HomePageComponent(http) {
        ...
        this.getRandomMatch = function () {
            ...
            console.log('click');
            _this.http.post("http://localhost:9200/clothes/_search", _this.queryClothes, _this.httpOptions)
            ...
            _this.http.post("http://localhost:9200/clothes/_search", _this.queryPants, _this.httpOptions)
                .subscribe(function (datas) {
                var data = datas.hits.hits;
                //console.log(data);
                if (data.length > 0) {
            ...
            _this.http.post("http://localhost:9200/clothes/_search", _this.queryShoes, _this.httpOptions)
                .subscribe(function (datas) {
                var data = datas.hits.hits;
                //console.log(data);
                if (data.length > 0) {
